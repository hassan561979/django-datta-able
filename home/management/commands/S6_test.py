...
from home.strategies.S6_test import BacktestView
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        symbols = Coin.objects.exclude(
            symbol__in=['MKRUSDT', 'TUSDUSDT', 'USDCUSDT', 'WBTCUSDT', 'YFIUSDT', 'BNBUSDT', 'ETHUSDT', 'BTCUSDT']).order_by('?')[:10]
        ...
        for symbol in symbols:
            try:
                ...
                print('S6 last date: ' + str(last_date) + ',time frame: ' + timeframe + ',stop loss: ' +
