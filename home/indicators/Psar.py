...
class Psar:
    ...
    def generate_signals(self):
       ...
       # Calculate Parabolic SAR
        ...
        PSARl =result['PSARl_{}_{}'.format(self.initial_acceleration,self.maximum_acceleration)]
        PSARl=PSARl.iloc[-1];
        PSARl=float(PSARl)
        
        PSARs =result['PSARs_{}_{}'.format(self.initial_acceleration,self.maximum_acceleration)]
        PSARs=PSARs.iloc[-1];
        PSARs=float(PSARs)
...
if __name__ == "__main__":
    ...
    symbols = ['API3USDT','TRBUSDT','BTCUSDT','HOT/USDT','SOL/USDT','MOVR/USDT','BNB/USDT','ETH/USDT']
    #symbols = ['TRBUSDT']
